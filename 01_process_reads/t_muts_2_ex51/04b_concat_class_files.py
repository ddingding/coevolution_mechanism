...
from constants import T_SINGLE_2_CALLED_DIR_M1, T_SINGLE_2_CALLED_DIR_M2, T_SINGLE_2_CALLED_DIR_BOTH
path1 =T_SINGLE_2_CALLED_DIR_M1
path2=T_SINGLE_2_CALLED_DIR_M2

dout =T_SINGLE_2_CALLED_DIR_BOTH
